...
import kotlinx.android.synthetic.main.activity_image_dashboard.*

class ImageDashboardActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun init() {
        supportActionBar?.title = getString(R.string.image_cropping_activity)
