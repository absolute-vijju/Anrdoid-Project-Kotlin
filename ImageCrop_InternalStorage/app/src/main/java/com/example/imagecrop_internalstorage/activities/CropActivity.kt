...
class CropActivity : AppCompatActivity() {
    ...
    private fun checkType(libraryType: Constants.LibraryType) {
        when (libraryType) {
            ...
            Constants.LibraryType.SimpleCropView -> addFragment(SimpleCropViewFragment.newInstance(null))
            Constants.LibraryType.Android_Image_Cropper -> addFragment(AndroidImageCropperFragment.newInstance(null))
            Constants.LibraryType.Cropper_NoCropper -> addFragment(CropperNoCropperFragment.newInstance(null))
        }
    }
